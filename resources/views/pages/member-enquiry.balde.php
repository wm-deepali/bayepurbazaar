...
<head>
    ...
    <style>
        ...
        .gradient-bg { background: linear-gradient(135deg, #0d9488 0%, #115e59 100%); }
        .input-focus:focus { outline: none; box-shadow: 0 0 0 4px rgba(13, 148, 136, 0.3); }
    </style>
</head>
<body class="bg-gray-50">
    ...
    <section class="py-16 md:py-24 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="bg-gradient-to-br from-teal-50 via-white to-orange-50 rounded-3xl shadow-2xl p-8 md:p-12 border border-teal-100">
                ...
                <form id="memberEnquiryForm" class="space-y-7">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">आप बायेपुर से कैसे जुड़े हैं? *</label>
                        <select required 
                            ...
                            <option value="nri">मैं बायेपुर से हूँ लेकिन बाहर रहता हूँ</option>
                            <option value="wellwisher">मैं बायेपुर का शुभचिंतक हूँ</option>
                            <option value="other">अन्य</option>
                        </select>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">आप किस तरह योगदान देना चाहेंगे? (एक या अधिक चुन सकते हैं)</label>
                        <div class="grid md:grid-cols-2 gap-4 mt-3">
                            <label class="flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-4 cursor-pointer hover:border-teal-400 transition">
                            ...
                            <label class="flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-4 cursor-pointer hover:border-teal-400 transition md:col-span-2">
                                <input type="checkbox" class="w-5 h-5 text-teal-600 rounded">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">आप हमें क्या बताना चाहेंगे? (वैकल्पिक)</label>
                        <textarea rows="5" 
                                  class="w-full border border-gray-300 rounded-xl py-4 px-5 focus:outline-none input-focus text-lg"
    ...
    <script>
        ...
        document.getElementById("memberEnquiryForm").addEventListener("submit", function(e) {
            e.preventDefault();
            alert("धन्यवाद! आपकी रुचि दर्ज हो गई है।\n\nहमारी टीम जल्द ही आपसे संपर्क करेगी।\n\nबायेपुर के साथ जुड़ने के लिए आपका बहुत-बहुत आभार!");
            this.reset();
        });
    </script>
   @endsection