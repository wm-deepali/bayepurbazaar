...
<div class="app-content content container-fluid">
    <div class="breadcrumbs-top d-flex align-items-center bg-light mb-3">
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item">Edit Team Member</li>
            </ol>
        </div>
   ...
   <div class="card" style="margin: 1rem;">
        ...
        <form class="product-details-information" action="{{ route('admin.manage-team.update',$team->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="product-detail-main">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" name="short_content" rows="3">{{ old('short_content',$team->short_content) }}</textarea>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <label class="label-control label">Replace Image?</label>
                        <input type="file" class="form-control" name="image">
                        <p class="mt-2">Current Image:</p>
                        <img src="{{ asset('storage/'.$team->image) }}" height="80">
