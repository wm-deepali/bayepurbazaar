...
<div class="app-content content container-fluid">
    ...
    <div class="card" style="margin: 1rem;">
        <div class="card-body content-wrapper">
            <form class="product-details-information" action="{{ route('admin.manage-blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="product-detail-main">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <label class="label-control label">Thumbnail Image</label>
                        <input type="file" class="form-control" name="thumbnail_image">
                        <small class="text-muted">Upload to replace</small>
                        @if($blog->thumbnail_image)
                            <br><img src="{{ asset('storage/'.$blog->thumbnail_image) }}" height="80" class="mt-1">
                        @endif
                    ...
                    <div class="col-md-6">
                        ...
                        @if($blog->banner_image)
                            <br><img src="{{ asset('storage/'.$blog->banner_image) }}" height="80" class="mt-1">
                        @endif
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" name="short_description" rows="3">{{ old('short_description', $blog->short_description) }}</textarea>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" name="detail_content" id="editor" cols="30" rows="10">{{ old('detail_content', $blog->detail_content) }}</textarea>
                        @error('detail_content')<div class="text-danger">{{ $message }}</div>@enderror
                    </div>
                </div>

                <div class="wdinput submit-btn-detail">
                    <input type="submit" value="Update" class="form-control bg-secondary text-white">
                </div>
