  ...
  <div class="container-fluid">
      <div class="top-main-header d-flex align-items-center">
          <div class="admin-logo">
            <img src="{{asset('/frontend/image/ChiroliftLogo.png')}}">  
          </div>
          <div class="ml-auto">
                   <div class="btn-group">
            ...
            <div class="dropdown-menu keep-open header-dropdown">
                <a class="dropdown-item" href="{{url('admin/profile-setting')}}"><i class="fa-light fa-user"></i> Profile </a>
                <a class="dropdown-item" href="{{url('admin/logout')}}"><i class="fa-light fa-power-off"></i> Logout</a>
            </div>
        </div>
      </div>
  </div>
